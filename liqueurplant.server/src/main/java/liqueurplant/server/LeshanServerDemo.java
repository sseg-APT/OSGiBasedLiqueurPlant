 ...
 *******************************************************************************/
package liqueurplant.server;

import liqueurplant.server.liqueurplant.LiqueurPlantServer;
import liqueurplant.server.servlet.ClientServlet;
import liqueurplant.server.servlet.EventServlet;
import liqueurplant.server.servlet.ObjectSpecServlet;
import liqueurplant.server.servlet.SecurityServlet;
...
public class LeshanServerDemo {
    ...
    private final static String USAGE = "java -jar leshan-server1-demo.jar [OPTION]";
    ...
    public static void main(String[] args) {
        ...
        options.addOption("wp", "webport", true, "Set the HTTP port for web server1.\nDefault: 8080.");
    ...
    public static void createAndStartServer(int webPort, String localAddress, int localPort, String secureLocalAddress,
        ...
        // Get public and private server1 key
        ...
        // Create and start LWM2M server1
        ...
        // Start Jetty & Leshan
        LiqueurPlantServer test = new LiqueurPlantServer(lwServer);
        lwServer.start();
        test.run();
        server.start();
        LOG.info("Web server1 started at {}.", server.getURI());
    }
}
